...
# Change year to numeric, so that it is 1-27 instead of 1992-2018
...
fish_rugosity_power = lm(Fish_Richness ~ exp(1.3053 + 0.4944*log(Rugosity)), data = variables)
...
fish_cover_power = lm(Fish_Richness ~ exp(2.5059 + 0.2305*log(Percent_Coral_Cover)), data = variables)
...
fish_coralrichness_power = lm(Fish_Richness ~ exp(2.1422 + 0.4041*log(Coral_Richness)), data = variables)
...
sponge_rugosity_power = lm(Sponge_Richness ~ exp(3.4258 + -0.1012*log(Rugosity)), data = variables)
...
# # Power models for cover
sponge_cover_power = lm(Sponge_Richness ~ exp(3.4226 + -0.1344*log(Percent_Coral_Cover)), data = variables)
...
# # Power models for coral richness
sponge_coralrichness_power = lm(Sponge_Richness ~ exp(3.5587 + -0.2029*log(Coral_Richness)), data = variables)
...
# # Power models for rugosity
coral_rugosity_power = lm(Coral_Richness ~ exp(1.2763 + 0.3302*log(Rugosity)), data = variables)
...
# # Power models for cover
coral_cover_power = lm(Coral_Richness ~ exp(1.6342 + 0.3108*log(Percent_Coral_Cover)), data = variables)
...
fishsponge_year = lm(Sponge_and_Fish_Richness ~ Year, data = variables)
fishsponge_site = lm(Sponge_and_Fish_Richness ~ Site, data = variables)
fishsponge_year_site = lm(Sponge_and_Fish_Richness ~ Year + Site, data = variables)
fishsponge_year_site_yearsite = lm(Sponge_and_Fish_Richness ~ Year + Site + Year*Site, data = variables)
fishsponge_coralrichness = lm(Sponge_and_Fish_Richness ~ Coral_Richness, data = variables)
fishsponge_coralrichness_site = lm(Sponge_and_Fish_Richness ~ Coral_Richness + Site, data = variables)
fishsponge_coralrichness_year = lm(Sponge_and_Fish_Richness ~ Coral_Richness + Year, data = variables)
fishsponge_coralrichness_year_site = lm(Sponge_and_Fish_Richness ~ Coral_Richness + Year + Site, data = variables)
fishsponge_year_site_yearsite_coralrichness = lm(Sponge_and_Fish_Richness ~ Year + Site + Year*Site + Coral_Richness, data = variables)
fishsponge_site_coralrichness_coralrichnesssite = lm(Sponge_and_Fish_Richness ~ Site + Coral_Richness + Coral_Richness*Site, data = variables)
fishsponge_year_coralrichness_coralrichnessyear = lm(Sponge_and_Fish_Richness ~ Year + Coral_Richness + Coral_Richness*Year, data = variables)
fishsponge_coralrichness_log = lm(Sponge_and_Fish_Richness ~ log(Coral_Richness), data = variables)
fishsponge_coralrichness_site_log = lm(Sponge_and_Fish_Richness ~ log(Coral_Richness) + Site, data = variables)
fishsponge_coralrichness_year_log = lm(Sponge_and_Fish_Richness ~ log(Coral_Richness) + Year, data = variables)
fishsponge_coralrichness_year_site_log = lm(Sponge_and_Fish_Richness ~ log(Coral_Richness) + Year + Site, data = variables)
fishsponge_year_site_yearsite_coralrichness_log = lm(Sponge_and_Fish_Richness ~ Year + Site + Year*Site + log(Coral_Richness), data = variables)
fishsponge_site_coralrichness_coralrichnesssite_log = lm(Sponge_and_Fish_Richness ~ Site + log(Coral_Richness) + log(Coral_Richness)*Site, data = variables)
...
# # Power models for rugosity
combined_rugosity_power = lm(Combined_Richness ~ exp(3.2653 + 0.2149*log(Rugosity)), data = variables)
...
# # Power models for cover
combined_cover_power = lm(Combined_Richness ~ exp(3.79088 + 0.09888*log(Percent_Coral_Cover)), data = variables)
...
# # Power models for coral richness
# combined_coralrichness_power = lm(Combined_Richness ~ exp(3.3032 + 0.3036*log(Coral_Richness)), data = variables)
...
# Create file with AIC table
#write.csv(fishsponge_aic_table, file = "spongeandfish_aic_table.csv")
...
ggplot(variables, aes(x = Rugosity, y = Fish_Richness)) + 
  ...
  geom_smooth(size = 1.2, method = "lm", formula = y ~ exp(1.3053 + 0.4944*log(x)), aes(color = "Power")) +
...
ggplot(variables, aes(x = Percent_Coral_Cover, y = Fish_Richness)) + 
  ...
  geom_smooth(size = 1.2, method = "lm", formula = y ~ x, aes(color = "Linear")) +
  geom_smooth(size = 1.2, method = "lm", formula = y ~ log(x), aes(color = "Logarithmic")) +
  geom_smooth(size = 1.2, method = "lm", formula = y ~ exp(2.5059 + 0.2305*log(x)), aes(color = "Power")) +
  scale_colour_manual(name = "Models", values = c("blue", "red", "green")) +
  theme(text=element_text(size=27), 
        panel.grid.major = element_line(colour="light gray", size = (0.5)), 
        panel.grid.minor = element_line(colour="light gray", size = (0.5)),
...
ggplot(variables, aes(x = Percent_Coral_Cover, y = Coral_Richness)) + 
  ...
  geom_smooth(size = 1.2, method = "lm", formula = y ~ x, aes(color = "Linear")) +
  geom_smooth(size = 1.2, method = "lm", formula = y ~ log(x), aes(color = "Logarithmic")) +
  geom_smooth(size = 1.2, method = "lm", formula = y ~ exp(1.6342 + 0.3108*log(x)), aes(color = "Power")) +
  scale_colour_manual(name = "Models", values = c("blue", "red", "green")) +
  theme(text=element_text(size=27), 
        panel.grid.major = element_line(colour="light gray", size = (0.5)), 
        panel.grid.minor = element_line(colour="light gray", size = (0.5)),
...
ggplot(variables, aes(x = Rugosity, y = Combined_Richness)) + 
  ...
  geom_smooth(size = 1.2, method = "lm", formula = y ~ x, aes(color = "Linear")) +
  geom_smooth(size = 1.2, method = "lm", formula = y ~ log(x), aes(color = "Logarithmic")) +
  geom_smooth(size = 1.2, method = "lm", formula = y ~ exp(3.2653 + 0.2149*log(x)), aes(color = "Power")) +
  scale_colour_manual(name = "Models", values = c("blue", "red", "green")) +
  theme(text=element_text(size=27), 
        panel.grid.major = element_line(colour="light gray", size = (0.5)), 
        panel.grid.minor = element_line(colour="light gray", size = (0.5)),
...
ggplot(variables, aes(x = Percent_Coral_Cover, y = Combined_Richness)) + 
  ...
  geom_smooth(size = 1.2, method = "lm", formula = y ~ x, aes(color = "Linear")) +
  geom_smooth(size = 1.2, method = "lm", formula = y ~ log(x), aes(color = "Logarithmic")) +
  geom_smooth(size = 1.2, method = "lm", formula = y ~ exp(3.79088 + 0.09888*log(x)), aes(color = "Power")) +
  scale_colour_manual(name = "Models", values = c("blue", "red", "green")) +
  theme(text=element_text(size=27), 
        panel.grid.major = element_line(colour="light gray", size = (0.5)), 
        panel.grid.minor = element_line(colour="light gray", size = (0.5)),
